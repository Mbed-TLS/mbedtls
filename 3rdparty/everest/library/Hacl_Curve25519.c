...
static void
Hacl_Bignum_Fmul_mul_shift_reduce_(uint128_t *output,
                                   uint64_t *input,
                                   uint64_t *input2)
{
    uint32_t i;
    uint64_t input2i;
    {
        ...
        for (i0 = (uint32_t)0U; i0 < (uint32_t)4U; i0 = i0 + (uint32_t)1U) {
            ...
            Hacl_Bignum_Fproduct_sum_scalar_multiplication_(output,
                                                            input,
                                                            input2i0);
...
inline static void Hacl_Bignum_Fmul_fmul(uint64_t *output,
                                         uint64_t *input,
                                         uint64_t *input2)
{
    uint64_t tmp[5U] = { 0U };
    ...
    KRML_CHECK_SIZE(sizeof(uint128_t), (uint32_t)5U);
    {
        ...
        }
        {
            ...
            b0_ = b0 + (uint128_t)(uint64_t)19U *
                  (uint64_t)(b4 >> (uint32_t)51U);
            t[4U] = b4_;
            t[0U] = b0_;
                                                 ...
                                                 uint64_t *output)
{
    ...
    uint128_t s3 = (uint128_t)d0 * r3 + (uint128_t)d1 * r2 + (uint128_t)r4 *
                   d419;
...
static void
Hacl_Bignum_Fsquare_fsquare_times_(uint64_t *input,
                                   uint128_t *tmp,
                                   uint32_t count1)
{
    uint32_t i;
...
inline static void
Hacl_Bignum_Fsquare_fsquare_times(uint64_t *output,
                                  uint64_t *input,
                                  uint32_t count1)
{
    KRML_CHECK_SIZE(sizeof(uint128_t), (uint32_t)5U);
...
inline static void Hacl_Bignum_fscalar(uint64_t *output, uint64_t *b,
                                       uint64_t s)
{
    KRML_CHECK_SIZE(sizeof(uint128_t), (uint32_t)5U);
    {
...
static void
Hacl_EC_Point_swap_conditional_step(uint64_t *a,
                                    uint64_t *b,
                                    uint64_t swap1,
                                    uint32_t ctr)
{
...
static void
Hacl_EC_Point_swap_conditional_(uint64_t *a,
                                uint64_t *b,
                                uint64_t swap1,
                                uint32_t ctr)
{
...
static void Hacl_EC_Point_swap_conditional(uint64_t *a,
                                           uint64_t *b,
                                           uint64_t iswap)
{
    ...
    )
{
    if (!(i == (uint32_t)0U)) {
        ...
        uint8_t byt_;
        Hacl_EC_Ladder_SmallLoop_cmult_small_loop_double_step(nq,
                                                              nqpq,
                                                              nq2,
                                                              nqpq2,
                                                              q,
        ...
        Hacl_EC_Ladder_SmallLoop_cmult_small_loop(nq,
                                                  nqpq,
                                                  nq2,
                                                  nqpq2,
                                                  q,
...
static void Hacl_EC_Ladder_cmult(uint64_t *result, uint8_t *n1, uint64_t *q)
{
    ...
    nq[0U] = (uint64_t)1U;
    Hacl_EC_Ladder_BigLoop_cmult_big_loop(n1,
                                          nq,
                                          nqpq,
                                          nq2,
                                          nqpq2,
