 ...
 *
 * Test file      : test_suite_aes.rest.c
 *
 ...
 *      Test suite file : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function
 *      Test suite data : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.rest.data
 *
 *
...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "MBEDTLS_ERR_AES_INVALID_KEY_LENGTH" ) == 0 )
    {
        *value = ( MBEDTLS_ERR_AES_INVALID_KEY_LENGTH );
        return( KEY_VALUE_MAPPING_FOUND );
    }
#ifdef MBEDTLS_CIPHER_MODE_CBC
    if( strcmp( str, "MBEDTLS_ERR_AES_INVALID_INPUT_LENGTH" ) == 0 )
    {
        *value = ( MBEDTLS_ERR_AES_INVALID_INPUT_LENGTH );
        return( KEY_VALUE_MAPPING_FOUND );
    }
...
#line 11 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function"
...
#line 45 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CBC
#line 79 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CBC
#line 117 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function"
...
#line 155 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CFB
#line 190 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CFB
#line 225 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CFB
#line 259 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function"
...
#line 293 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.function"
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "aes_decrypt_ecb" ) == 0 )
    {
    ...
    if( strcmp( params[0], "aes_encrypt_cbc" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CBC
    ...
    if( strcmp( params[0], "aes_decrypt_cbc" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CBC
    ...
    if( strcmp( params[0], "aes_encrypt_cfb128" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CFB
    ...
    if( strcmp( params[0], "aes_decrypt_cfb128" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CFB
    ...
    if( strcmp( params[0], "aes_encrypt_cfb8" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CFB
    ...
    if( strcmp( params[0], "aes_decrypt_cfb8" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CFB
    ...
    if( strcmp( params[0], "aes_selftest" ) == 0 )
    {
    #ifdef MBEDTLS_SELF_TEST
...
#define USAGE \
    ...
    argv[0], \
    "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.rest.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_aes.rest.data";
