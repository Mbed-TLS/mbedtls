 ...
 *      Test suite file : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_asn1write.function
 *      Test suite data : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_asn1write.data
 *
 *
...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "MBEDTLS_ERR_ASN1_BUF_TOO_SMALL" ) == 0 )
    {
        *value = ( MBEDTLS_ERR_ASN1_BUF_TOO_SMALL );
...
#line 14 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_asn1write.function"
void test_suite_mbedtls_asn1_write_octet_string( char *hex_str, char *hex_asn1,
...
#line 51 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_asn1write.function"
void test_suite_mbedtls_asn1_write_ia5_string( char *str, char *hex_asn1,
                            int buf_len, int result )
{
    int ret;
    unsigned char buf[150];
...
#line 87 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_asn1write.function"
void test_suite_mbedtls_asn1_write_len( int len, char *check_str, int buf_len,
                             int result )
{
    int ret;
    unsigned char buf[150];
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "mbedtls_asn1_write_octet_string" ) == 0 )
    {
        ...
        test_suite_mbedtls_asn1_write_octet_string( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "mbedtls_asn1_write_ia5_string" ) == 0 )
    {
        ...
        test_suite_mbedtls_asn1_write_ia5_string( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "mbedtls_asn1_write_len" ) == 0 )
    {
        ...
        test_suite_mbedtls_asn1_write_len( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );
...
#define USAGE \
    ...
    argv[0], \
    "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_asn1write.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_asn1write.data";
