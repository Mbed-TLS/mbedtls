 ...
 *      Test suite file : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_ccm.function
 *      Test suite data : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_ccm.data
 *
 *
...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "MBEDTLS_CIPHER_ID_BLOWFISH" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_ID_BLOWFISH );
        return( KEY_VALUE_MAPPING_FOUND );
    }
    if( strcmp( str, "MBEDTLS_ERR_CCM_BAD_INPUT" ) == 0 )
    {
        *value = ( MBEDTLS_ERR_CCM_BAD_INPUT );
        return( KEY_VALUE_MAPPING_FOUND );
    }
...
#ifdef MBEDTLS_AES_C
#line 11 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_ccm.function"
void test_suite_mbedtls_ccm_self_test( )
{
...
#line 18 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_ccm.function"
void test_suite_mbedtls_ccm_setkey( int cipher_id, int key_size, int result )
{
...
#ifdef MBEDTLS_AES_C
#line 38 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_ccm.function"
...
#line 78 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_ccm.function"
void test_suite_mbedtls_ccm_encrypt_and_tag( int cipher_id,
...
#line 123 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_ccm.function"
void test_suite_mbedtls_ccm_auth_decrypt( int cipher_id,
                       char *key_hex, char *msg_hex,
                       char *iv_hex, char *add_hex,
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "mbedtls_ccm_self_test" ) == 0 )
    {
    #ifdef MBEDTLS_SELF_TEST
    #ifdef MBEDTLS_AES_C
        ...
        test_suite_mbedtls_ccm_self_test(  );
    ...
    if( strcmp( params[0], "mbedtls_ccm_setkey" ) == 0 )
    {
        ...
        test_suite_mbedtls_ccm_setkey( param1, param2, param3 );
        return ( DISPATCH_TEST_SUCCESS );
    ...
    if( strcmp( params[0], "mbedtls_ccm_encrypt_and_tag" ) == 0 )
    {
        ...
        test_suite_mbedtls_ccm_encrypt_and_tag( param1, param2, param3, param4, param5, param6 );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "mbedtls_ccm_auth_decrypt" ) == 0 )
    {
        ...
        test_suite_mbedtls_ccm_auth_decrypt( param1, param2, param3, param4, param5, param6, param7 );
        return ( DISPATCH_TEST_SUCCESS );
...
#define USAGE \
    ...
    argv[0], \
    "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_ccm.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_ccm.data";
