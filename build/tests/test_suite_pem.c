 ...
 *      Test suite file : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pem.function
 *      Test suite data : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pem.data
 *
 *
...
#line 7 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pem.function"
...
#ifdef MBEDTLS_MD5_C
#ifdef MBEDTLS_CIPHER_MODE_CBC
#line 38 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pem.function"
void test_suite_mbedtls_pem_read_buffer( char *header, char *footer, char *data, int ret )
{
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "mbedtls_pem_write_buffer" ) == 0 )
    {
    #ifdef MBEDTLS_PEM_WRITE_C
        ...
        test_suite_mbedtls_pem_write_buffer( param1, param2, param3, param4 );
    ...
    if( strcmp( params[0], "mbedtls_pem_read_buffer" ) == 0 )
    {
    #ifdef MBEDTLS_PEM_PARSE_C
    #ifdef MBEDTLS_AES_C
    #ifdef MBEDTLS_DES_C
        ...
        test_suite_mbedtls_pem_read_buffer( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_PEM_PARSE_C */
    #endif /* MBEDTLS_AES_C */
    #endif /* MBEDTLS_DES_C */
...
#define USAGE \
    ...
    argv[0], \
    "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pem.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pem.data";
