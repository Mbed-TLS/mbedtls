 ...
 *      Test suite file : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pkparse.function
 *      Test suite data : /home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pkparse.data
 *
 *
...
#ifdef MBEDTLS_RSA_C
#ifdef MBEDTLS_FS_IO
    if( strcmp( str, "MBEDTLS_ERR_PK_KEY_INVALID_FORMAT" ) == 0 )
    {
        *value = ( MBEDTLS_ERR_PK_KEY_INVALID_FORMAT );
...
#ifdef MBEDTLS_RSA_C
#ifdef MBEDTLS_FS_IO
    if( strcmp( str, "MBEDTLS_ERR_PK_PASSWORD_REQUIRED" ) == 0 )
    {
        *value = ( MBEDTLS_ERR_PK_PASSWORD_REQUIRED );
        return( KEY_VALUE_MAPPING_FOUND );
    }
#endif // MBEDTLS_RSA_C
#endif // MBEDTLS_FS_IO
#ifdef MBEDTLS_RSA_C
#ifdef MBEDTLS_FS_IO
    if( strcmp( str, "MBEDTLS_ERR_PK_PASSWORD_MISMATCH" ) == 0 )
    {
        *value = ( MBEDTLS_ERR_PK_PASSWORD_MISMATCH );
        return( KEY_VALUE_MAPPING_FOUND );
    }
#endif // MBEDTLS_RSA_C
#endif // MBEDTLS_FS_IO
...
#ifdef MBEDTLS_RSA_C
#ifdef MBEDTLS_FS_IO
#line 13 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pkparse.function"
...
#ifdef MBEDTLS_RSA_C
#ifdef MBEDTLS_FS_IO
#line 42 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pkparse.function"
...
#ifdef MBEDTLS_FS_IO
#ifdef MBEDTLS_ECP_C
#line 67 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pkparse.function"
...
#ifdef MBEDTLS_FS_IO
#ifdef MBEDTLS_ECP_C
#line 92 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pkparse.function"
...
#ifdef MBEDTLS_RSA_C
#line 117 "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pkparse.function"
...
int dep_check( char *str )
{
    ...
    if( strcmp( str, "MBEDTLS_PK_PARSE_EC_EXTENDED" ) == 0 )
    {
    ...
    if( strcmp( str, "MBEDTLS_PKCS5_C" ) == 0 )
    {
    ...
    if( strcmp( str, "MBEDTLS_PKCS12_C" ) == 0 )
    {
...
#define USAGE \
    ...
    argv[0], \
    "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pkparse.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/home/clm/PATCH_mbed/mbedtls/tests/suites/test_suite_pkparse.data";
