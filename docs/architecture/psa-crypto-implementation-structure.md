...
* [ ] `framework/scripts/framework_dev/crypto_knowledge.py`, `framework/scripts/framework_dev/asymmetric_key_data.py` — [Unit tests](#unit-tests)
...
* `framework/scripts/framework_dev/crypto_knowledge.py` contains knowledge about the compatibility of key types, key sizes and algorithms.
* `framework/scripts/framework_dev/asymmetric_key_data.py` contains valid key data for asymmetric key types.
