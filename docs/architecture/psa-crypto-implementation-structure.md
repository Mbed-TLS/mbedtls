...
* [ ] `scripts/test_frm_dev/crypto_knowledge.py`, `scripts/test_frm_dev/asymmetric_key_data.py` — [Unit tests](#unit-tests)
...
* `scripts/test_frm_dev/crypto_knowledge.py` contains knowledge about the compatibility of key types, key sizes and algorithms.
* `scripts/test_frm_dev/asymmetric_key_data.py` contains valid key data for asymmetric key types.
