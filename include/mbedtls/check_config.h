...
#error "MBEDTLS_MILAGRO_CS_ENABLE_PIN defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_MILAGRO_CS_TIME_PERMITS) &&                    \
!defined(MBEDTLS_MILAGRO_CS_C)
#error "MBEDTLS_MILAGRO_CS_TIME_PERMITS defined, but not all prerequisites"
#endif

#if defined(MBEDTLS_KEY_EXCHANGE_MILAGRO_CS_ENABLED) &&                    \
( !defined(MBEDTLS_MILAGRO_CS_C) || !defined(MBEDTLS_AES_C) ||            \
...
( !defined(MBEDTLS_MILAGRO_P2P_C) || !defined(MBEDTLS_AES_C) ||            \
!defined(MBEDTLS_GCM_C) || !defined(MBEDTLS_SHA256_C) )
