...
#if defined MBEDTLS_SSL_BUFFER_LEN
#define SSL_BUFFER_LEN MBEDTLS_SSL_BUFFER_LEN
#elif MBEDTLS_SSL_IN_BUFFER_LEN > MBEDTLS_SSL_OUT_BUFFER_LEN
#define SSL_BUFFER_LEN MBEDTLS_SSL_IN_BUFFER_LEN
#else
#define SSL_BUFFER_LEN MBEDTLS_SSL_OUT_BUFFER_LEN
#endif
