...
/* Internal macro to state that there is at least 1 domain parameter which is builtin. */
...
#define MBEDTLS_PSA_DH_ACCEL_INCOMPLETE_PARAMS
#endif

#if defined(PSA_WANT_ALG_FFDH)
#if !defined(MBEDTLS_PSA_ACCEL_ALG_FFDH) || defined(MBEDTLS_PSA_DH_ACCEL_INCOMPLETE_PARAMS)
