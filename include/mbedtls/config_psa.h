 ...
 * in the block cipher key types. */
        ...
        (defined(PSA_WANT_ALG_XTS) && !defined(MBEDTLS_PSA_ACCEL_ALG_XTS)) || defined(PSA_WANT_ALG_ECB_NO_PADDING) || \
 ...
 * situations. */
#if defined(PSA_HAVE_SOFT_KEY_TYPE_AES) || defined(PSA_HAVE_SOFT_KEY_TYPE_DES) || \
