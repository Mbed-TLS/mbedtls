...
/**
 * \brief           This function frees and clears the internal structures of 
 *                  \p ctx.
 *
 *                  It can be called at any time after mbedtls_md_init().
 *                  It must be called once mbedtls_md_setup() has been called.
 */
 ...
 *
 *                  It is usually called after mbedtls_md_setup() or 
 ...
 *
 *                  It is called after mbedtls_md_hmac_update().
 *                  It is usually followed by mbedtls_md_hmac_reset(),
 ...
 *
 *                  It is called after mbedtls_md_hmac_finish(), and before
 *                  mbedtls_md_hmac_update().
 *
 * \param ctx       The HMAC context to reset.
 *
 * \returns         \c 0 on success, or #MBEDTLS_ERR_MD_BAD_INPUT_DATA if 
 *                  parameter verification fails.
 */
