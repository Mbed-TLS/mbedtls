...
#define MBEDTLS_ERR_NET_CONNECT_FAILED \
    -0x0044 /**< The connection to the given server / port failed. */
#define MBEDTLS_ERR_NET_BIND_FAILED \
    -0x0046 /**< Binding of the socket failed. */
#define MBEDTLS_ERR_NET_LISTEN_FAILED \
    -0x0048 /**< Could not listen on the socket. */
#define MBEDTLS_ERR_NET_ACCEPT_FAILED \
    -0x004A /**< Could not accept the incoming connection. */
...
#define MBEDTLS_ERR_NET_BUFFER_TOO_SMALL \
    -0x0043 /**< Buffer is too small to hold the data. */
#define MBEDTLS_ERR_NET_INVALID_CONTEXT \
    -0x0045 /**< The context is invalid, eg because it was free()ed. */
#define MBEDTLS_ERR_NET_POLL_FAILED \
    -0x0047 /**< Polling the net context failed. */
