 ...
 * \param hash_id  The hash identifier of ::bedtls_md_type_t type, if
 ...
 *                 of length \c ctx->len Bytes. For example, \c 128 Bytes
 *                 for an 1024-bit RSA modulus.
 ...
 *                 buffer of length \c ctx->len Bytes. For example, \c 128 Bytes
 *                 for an 1024-bit RSA modulus.
 *
