...
#define MBEDTLS_ERR_SHAKE_BAD_INPUT_DATA   -0x002D /**< Invalid input parameter(s). */
#define MBEDTLS_ERR_SHAKE_BAD_NOT_STARTED  -0x002F /**< mbedtls_keccak_sponge_starts has not been called. */
#define MBEDTLS_ERR_SHAKE_BAD_STATE        -0x0031 /**< Requested operation cannot be performed with the current context state. */
