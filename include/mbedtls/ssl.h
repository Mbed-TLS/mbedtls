...
struct mbedtls_ssl_session {
    ...
    unsigned char MBEDTLS_PRIVATE(resumption_key)[
...
struct mbedtls_ssl_config {
    ...
    int(*MBEDTLS_PRIVATE(f_sni))(void *, mbedtls_ssl_context *,
    ...
    int(*MBEDTLS_PRIVATE(f_psk))(void *, mbedtls_ssl_context *,
                                 const unsigned char *, size_t);
    ...
    int(*MBEDTLS_PRIVATE(f_cookie_write))(void *, unsigned char **,
                                          unsigned char *,
                                          const unsigned char *, size_t);
    ...
    int(*MBEDTLS_PRIVATE(f_ticket_parse))(void *, mbedtls_ssl_session *,
...
static inline const char *mbedtls_ssl_get_srtp_profile_as_string(
