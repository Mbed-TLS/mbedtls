 ...
 *                  When TLS 1.3 enabled, it MUST NOT be greater than 7 days or
 *                  zero. Otherwise, \c MBEDTLS_ERR_SSL_BAD_INPUT_DATA will be
 *                  raised when create new session tickets in TLS 1.3 connection.
 *
