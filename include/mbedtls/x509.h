...
#define MBEDTLS_ERR_X509_INVALID_FORMAT                                 \
    -0x2180 /**< The CRT/CRL/CSR format is invalid, e.g. different type \
               expected. */
...
#define MBEDTLS_ERR_X509_SIG_MISMATCH                                          \
    -0x2680 /**< Signature algorithms do not match. (see \c ::mbedtls_x509_crt \
               sig_oid) */
#define MBEDTLS_ERR_X509_CERT_VERIFY_FAILED                                 \
    -0x2700 /**< Certificate verification failed, e.g. CRL, CA or signature \
               check failed. */
...
#define MBEDTLS_ERR_X509_FATAL_ERROR                                          \
    -0x3000 /**< A fatal error occurred, eg the chain is too long or the vrfy \
               callback failed. */
/* \} name */
