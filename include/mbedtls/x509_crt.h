...
typedef struct mbedtls_x509_crt {
        ...
        mbedtls_x509_sequence MBEDTLS_PRIVATE(subject_alt_names); /**< Optional list of raw entries of Subject
                                                                     Alternative Names extension (currently only dNSName
                                                                     and OtherName are listed). */

        mbedtls_x509_sequence MBEDTLS_PRIVATE(certificate_policies); /**< Optional list of certificate policies (Only
                                                                        anyPolicy is printed and enforced, however the
                                                                        rest of the policies are still listed). */

        int MBEDTLS_PRIVATE(ext_types); /**< Bit string containing detected and parsed extensions */
        int MBEDTLS_PRIVATE(ca_istrue); /**< Optional Basic Constraint extension value: 1 if this certificate belongs to
                                           a CA, 0 otherwise. */
        ...
        unsigned char MBEDTLS_PRIVATE(ns_cert_type); /**< Optional Netscape certificate type extension value: See the
                                                        values in x509.h */
...
typedef struct mbedtls_x509_subject_alternative_name {
        ...
        union {
                ...
                mbedtls_x509_buf MBEDTLS_PRIVATE(unstructured_name); /**< The buffer for the un constructed types. Only
