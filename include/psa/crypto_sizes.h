...
#define PSA_HASH_LENGTH(alg)                                                                             \
        (PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_MD5 ? 16 :                                                \
                                                     ...
                                                     28 :                                                \
                                                     PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_256 ?     \
                                                     32 :                                                \
                                                     PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_384 ?     \
                                                     48 :                                                \
                                                     PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_512 ?     \
                                                     64 :                                                \
                                                     PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_512_224 ? \
                                                     28 :                                                \
                                                     PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA_512_256 ? \
                                                     32 :                                                \
                                                     PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA3_224 ?    \
                                                     28 :                                                \
                                                     PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA3_256 ?    \
                                                     32 :                                                \
                                                     PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA3_384 ?    \
                                                     48 :                                                \
                                                     PSA_ALG_HMAC_GET_HASH(alg) == PSA_ALG_SHA3_512 ? 64 : 0)
...
#define PSA_AEAD_TAG_LENGTH(key_type, key_bits, alg) \
        (PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 ? PSA_ALG_AEAD_GET_TAG_LENGTH(alg) : ((void)(key_bits), 0))
...
#define PSA_AEAD_ENCRYPT_OUTPUT_SIZE(key_type, alg, plaintext_length) \
        (PSA_AEAD_NONCE_LENGTH(key_type, alg) != 0 ? (plaintext_length) + PSA_ALG_AEAD_GET_TAG_LENGTH(alg) : 0)
...
#define PSA_AEAD_NONCE_LENGTH(key_type, alg)                                                                         \
        (PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) == 16 ?                                                             \
                 ...
                 (key_type) == PSA_KEY_TYPE_CHACHA20 && MBEDTLS_PSA_ALG_AEAD_EQUAL(alg, PSA_ALG_CHACHA20_POLY1305) ? \
                 12 :                                                                                                \
                 0)
...
#define PSA_SIGN_OUTPUT_SIZE(key_type, key_bits, alg)       \
        (PSA_KEY_TYPE_IS_RSA(key_type) ?                    \
                 ...
                 PSA_KEY_TYPE_IS_ECC(key_type) ? PSA_ECDSA_SIGNATURE_SIZE(key_bits) : ((void)alg, 0))
...
#define PSA_EXPORT_KEY_OUTPUT_SIZE(key_type, key_bits)              \
        (PSA_KEY_TYPE_IS_UNSTRUCTURED(key_type) ?                   \
                 ...
                 PSA_KEY_TYPE_IS_ECC_PUBLIC_KEY(key_type) ? PSA_KEY_EXPORT_ECC_PUBLIC_KEY_MAX_SIZE(key_bits) : 0)
...
#define PSA_EXPORT_PUBLIC_KEY_OUTPUT_SIZE(key_type, key_bits)       \
        (PSA_KEY_TYPE_IS_RSA(key_type) ?                            \
                 PSA_KEY_EXPORT_RSA_PUBLIC_KEY_MAX_SIZE(key_bits) : \
                 PSA_KEY_TYPE_IS_ECC(key_type) ? PSA_KEY_EXPORT_ECC_PUBLIC_KEY_MAX_SIZE(key_bits) : 0)
...
#define PSA_CIPHER_IV_LENGTH(key_type, alg)                                                                        \
        (PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) > 1 &&                                                            \
                         ((alg) == PSA_ALG_CTR || (alg) == PSA_ALG_CFB || (alg) == PSA_ALG_OFB ||                  \
                          (alg) == PSA_ALG_XTS || (alg) == PSA_ALG_CBC_NO_PADDING || (alg) == PSA_ALG_CBC_PKCS7) ? \
                 PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type) :                                                         \
                 (key_type) == PSA_KEY_TYPE_CHACHA20 && (alg) == PSA_ALG_STREAM_CIPHER ? 12 : 0)
...
#define PSA_CIPHER_ENCRYPT_OUTPUT_SIZE(key_type, alg, input_length)                                      \
        (alg == PSA_ALG_CBC_PKCS7 ?                                                                      \
                 PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_LENGTH(key_type), (input_length) + 1) + \
...
#define PSA_CIPHER_ENCRYPT_OUTPUT_MAX_SIZE(input_length) \
        (PSA_ROUND_UP_TO_MULTIPLE(PSA_BLOCK_CIPHER_BLOCK_MAX_SIZE, (input_length) + 1) + PSA_CIPHER_IV_MAX_SIZE)
