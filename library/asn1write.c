...
int mbedtls_asn1_write_int(unsigned char **p, const unsigned char *start,
                           int val)
{
    return asn1_write_tagged_int(p, start, val, MBEDTLS_ASN1_INTEGER);
}

int mbedtls_asn1_write_enum(unsigned char **p, const unsigned char *start,
                            int val)
{
...
int mbedtls_asn1_write_tagged_string(unsigned char **p,
                                     const unsigned char *start, int tag,
...
int mbedtls_asn1_write_printable_string(unsigned char **p,
                                        ...
                                        const char *text, size_t text_len)
{
    return mbedtls_asn1_write_tagged_string(p, start,
                                            MBEDTLS_ASN1_PRINTABLE_STRING, text,
                                            text_len);
}
