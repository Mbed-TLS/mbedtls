...
const size_t mbedtls_test_ca_pwd_ec_len = 0;
...
/* This is taken from tests/data_files/server11.key. */
...
/* This is taken from tests/data_files/cli3.crt.pem. */
...
/* List of all available CA certificates in PEM format */
...
const char *mbedtls_test_ca_crt  = (const char*) mbedtls_test_ca_crt_rsa_der;
const char *mbedtls_test_ca_key  = (const char*) mbedtls_test_ca_key_rsa_der;
const char *mbedtls_test_ca_pwd  = (const char*) NULL;
const char *mbedtls_test_srv_crt = (const char*) mbedtls_test_srv_crt_rsa_der;
const char *mbedtls_test_srv_key = (const char*) mbedtls_test_srv_key_rsa_der;
const char *mbedtls_test_cli_crt = (const char*) mbedtls_test_cli_crt_rsa_der;
const char *mbedtls_test_cli_key = (const char*) mbedtls_test_cli_key_rsa_der;
...
const size_t mbedtls_test_srv_crt_len = sizeof( mbedtls_test_srv_crt_rsa_der );
const size_t mbedtls_test_srv_key_len = sizeof( mbedtls_test_srv_key_rsa_der );
const size_t mbedtls_test_cli_crt_len = sizeof( mbedtls_test_cli_crt_rsa_der );
const size_t mbedtls_test_cli_key_len = sizeof( mbedtls_test_cli_key_rsa_der );
#endif /* MBEDTLS_PEM_PARSE_C */
...
#else /* MBEDTLS_PEM_PARSE_C */
const char *mbedtls_test_ca_crt  = (const char*) mbedtls_test_ca_crt_ec_der;
const char *mbedtls_test_ca_key  = (const char*) mbedtls_test_ca_key_ec_der;
const char *mbedtls_test_ca_pwd  = (const char*) NULL;
const char *mbedtls_test_srv_crt = (const char*) mbedtls_test_srv_crt_ec_der;
const char *mbedtls_test_srv_key = (const char*) mbedtls_test_srv_key_ec_der;
const char *mbedtls_test_cli_crt = (const char*) mbedtls_test_cli_crt_ec_der;
const char *mbedtls_test_cli_key = (const char*) mbedtls_test_cli_key_ec_der;
...
const size_t mbedtls_test_ca_pwd_len  = 0;
const size_t mbedtls_test_srv_crt_len = sizeof( mbedtls_test_srv_crt_ec_der );
const size_t mbedtls_test_srv_key_len = sizeof( mbedtls_test_srv_key_ec_der );
const size_t mbedtls_test_cli_crt_len = sizeof( mbedtls_test_cli_crt_ec_der );
const size_t mbedtls_test_cli_key_len = sizeof( mbedtls_test_cli_key_ec_der );
#endif /* MBEDTLS_PEM_PARSE_C */
#endif /* MBEDTLS_RSA_C */
