...
static const unsigned char test_keys[3][32] =
{
    {
...
static const unsigned char test_nonces[3][12] =
{
    {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00
...
static const uint32_t test_counters[3] =
{
    0U,
    1U,
    0U
...
static const unsigned char test_input[3][375] =
{
    {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static const unsigned char test_output[3][375] =
{
    {
...
static const size_t test_lengths[3] =
{
    64U,
    375U,
    128U
...
int mbedtls_chacha20_self_test(int verbose)
{
    ...
    for (i = 0U; i < 3U; i++) {
        ...
        if (i != 2U) {
            ...
            ret = mbedtls_chacha20_setkey(&ctx, test_keys[i]);
            if (ret != 0) {
                mbedtls_chacha20_free(&ctx);
                return ret;
            }

            ret = mbedtls_chacha20_set_iv(&ctx, test_nonces[i], 8U, test_counters[i]);
            if (ret != 0) {
                mbedtls_chacha20_free(&ctx);
                return ret;
            }

            ret = mbedtls_chacha20_update(&ctx, test_lengths[i], test_input[i], output);
        }
