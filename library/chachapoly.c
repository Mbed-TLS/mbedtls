                                       ...
                                       unsigned char* output, unsigned char tag[16])
{
        ...
        return (chachapoly_crypt_and_tag(ctx, MBEDTLS_CHACHAPOLY_ENCRYPT, length, nonce, aad, aad_len, input, output,
                                         tag));
}
...
int mbedtls_chachapoly_self_test(int verbose)
{
        ...
        for (i = 0U; i < 1U; i++) {
                ...
                ret = mbedtls_chachapoly_encrypt_and_tag(&ctx, test_input_len[i], test_nonce[i], test_aad[i],
                                                         test_aad_len[i], test_input[i], output, mac);
