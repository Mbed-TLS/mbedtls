...
static int aes_crypt_cfb128_wrap(void *ctx,
                                 ...
                                 unsigned char *output)
{
    return mbedtls_aes_crypt_cfb128((mbedtls_aes_context *)ctx,
                                    operation,
                                    length,
                                    iv_off,
                                    iv,
...
static int aes_crypt_ctr_wrap(void *ctx,
                              ...
                              unsigned char *output)
{
    return mbedtls_aes_crypt_ctr((mbedtls_aes_context *)ctx,
                                 length,
                                 nc_off,
                                 nonce_counter,
                                 stream_block,
...
static int camellia_crypt_ctr_wrap(void *ctx,
                                   ...
                                   unsigned char *output)
{
    return mbedtls_camellia_crypt_ctr((mbedtls_camellia_context *)ctx,
                                      length,
                                      nc_off,
                                      nonce_counter,
                                      stream_block,
...
static int camellia_setkey_dec_wrap(void *ctx, const unsigned char *key,
                                    unsigned int key_bitlen)
{
    return mbedtls_camellia_setkey_dec((mbedtls_camellia_context *)ctx,
                                       key,
                                       key_bitlen);
}
...
static int camellia_setkey_enc_wrap(void *ctx, const unsigned char *key,
                                    unsigned int key_bitlen)
{
    return mbedtls_camellia_setkey_enc((mbedtls_camellia_context *)ctx,
                                       key,
                                       key_bitlen);
}
...
static int aria_crypt_cbc_wrap(void *ctx, mbedtls_operation_t operation,
                               ...
                               unsigned char *output)
{
    return mbedtls_aria_crypt_cbc((mbedtls_aria_context *)ctx,
                                  operation,
                                  length,
                                  iv,
                                  input,
...
static int aria_crypt_cfb128_wrap(void *ctx,
                                  ...
                                  unsigned char *output)
{
    return mbedtls_aria_crypt_cfb128((mbedtls_aria_context *)ctx,
                                     operation,
                                     length,
                                     iv_off,
                                     iv,
...
static int des_crypt_cbc_wrap(void *ctx,
                              ...
                              unsigned char *output)
{
    return mbedtls_des_crypt_cbc((mbedtls_des_context *)ctx,
                                 operation,
                                 length,
                                 iv,
                                 input,
...
static int des3_crypt_cbc_wrap(void *ctx,
                               ...
                               unsigned char *output)
{
    return mbedtls_des3_crypt_cbc((mbedtls_des3_context *)ctx,
                                  operation,
                                  length,
                                  iv,
                                  input,
                                  ...
                                  unsigned int key_bitlen)
{
    ...
    if (0 !=
        mbedtls_chachapoly_setkey((mbedtls_chachapoly_context *)ctx, key)) {
        return MBEDTLS_ERR_CIPHER_BAD_INPUT_DATA;
    }
...
const mbedtls_cipher_definition_t mbedtls_cipher_definitions[] =
{
    ...
    { MBEDTLS_CIPHER_CAMELLIA_128_CCM_STAR_NO_TAG,
      &camellia_128_ccm_star_no_tag_info },
    { MBEDTLS_CIPHER_CAMELLIA_192_CCM_STAR_NO_TAG,
