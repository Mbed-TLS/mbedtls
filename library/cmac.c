 ...
 */
static void cmac_pad(
    unsigned char       padded_block[MBEDTLS_CIPHER_BLKSIZE_MAX],
...
static const unsigned char aes_128_expected_result[NB_CMAC_TESTS_PER_KEY][
...
static const unsigned char aes_192_expected_result[NB_CMAC_TESTS_PER_KEY][
    MBEDTLS_AES_BLOCK_SIZE] =
{
    {
        /* Example #1 */
...
static const unsigned char aes_256_expected_result[NB_CMAC_TESTS_PER_KEY][
    MBEDTLS_AES_BLOCK_SIZE] =
{
    {
        /* Example #1 */
...
static const unsigned char des3_2key_expected_result[NB_CMAC_TESTS_PER_KEY][
...
static const unsigned char des3_3key_expected_result[NB_CMAC_TESTS_PER_KEY][
    MBEDTLS_DES3_BLOCK_SIZE] =
{
    {
        /* Sample #1 */
                                ...
                                int                   num_tests)
{
    ...
    for (i = 0; i < num_tests; i++) {
        ...
        if ((ret =
                 memcmp(output, &expected_result[i * block_size],
                        block_size)) != 0) {
            if (verbose != 0) {
                mbedtls_printf("failed\n");
            }
