...
/* This is a slight waste of memory, but in the context of memory used for
 * the ECP operations overall, it does not have a significant impact. */
static mbedtls_mpi_uint mpi_one[MBEDTLS_ECP_MAX_LIMBS] = { 1 };
#endif
