...
#define MBEDTLS_ERR_MPS_READER_DATA_LEFT             \
    MBEDTLS_MPS_READER_MAKE_ERROR(0x1)

/*! An invalid argument was passed to the reader. */
#define MBEDTLS_ERR_MPS_READER_INVALID_ARG           \
    MBEDTLS_MPS_READER_MAKE_ERROR(0x2)
