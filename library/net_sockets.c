...
#include "common.h"
        ...
        !defined(__QNXNTO__) && !defined(__HAIKU__) && !defined(__midipix__)
 ...
 */
int mbedtls_net_accept(mbedtls_net_context* bind_ctx, mbedtls_net_context* client_ctx, void* client_ip, size_t buf_size,
                       size_t* ip_len)
{
        int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
        int type;
        ...
        defined(__DEFINED_socklen_t) || defined(socklen_t) || (defined(_POSIX_VERSION) && _POSIX_VERSION >= 200112L)
