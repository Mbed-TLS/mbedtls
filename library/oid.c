...
{
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AT_CN,
                       "id-at-commonName",
                       "Common Name"),
        "CN",
    },
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AT_COUNTRY,
                       "id-at-countryName",
                       "Country"),
        "C",
    },
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AT_LOCALITY,
                       "id-at-locality",
                       "Locality"),
        "L",
    },
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AT_STATE,
                       "id-at-state",
                       "State"),
        "ST",
    },
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AT_SUR_NAME,
                       "id-at-surName",
                       "Surname"),
        "SN",
    },
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AT_INITIALS,
                       "id-at-initials",
                       "Initials"),
        "initials",
    },
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AT_TITLE,
                       "id-at-title",
                       "Title"),
        "title",
    },
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_AT_PSEUDONYM,
                       "id-at-pseudonym",
                       "Pseudonym"),
        "pseudonym",
    },
    {
        OID_DESCRIPTOR(MBEDTLS_OID_UID,
                       "id-uid",
                       "User Id"),
        "uid",
    },
...
{
    OID_DESCRIPTOR(MBEDTLS_OID_ANY_POLICY,      "anyPolicy",
                   "Any Policy"),
    NULL_OID_DESCRIPTOR,
};
...
#if defined(MBEDTLS_RSA_C)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_RSASSA_PSS,
                       "RSASSA-PSS",
                       "RSASSA-PSS"),
...
{
    {
        OID_DESCRIPTOR(MBEDTLS_OID_PKCS1_RSA,
                       "rsaEncryption",
                       "RSA"),
        MBEDTLS_PK_RSA,
    },
    ...
    {
        OID_DESCRIPTOR(MBEDTLS_OID_EC_ALG_ECDH,
                       "id-ecDH",
                       "EC key for ECDH"),
        MBEDTLS_PK_ECKEY_DH,
    },
...
{
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DES_CBC,
                       "desCBC",
                       "DES-CBC"),
        MBEDTLS_CIPHER_DES_CBC,
    },
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DES_EDE3_CBC,
                       "des-ede3-cbc",
                       "DES-EDE3-CBC"),
...
#if defined(MBEDTLS_HAS_ALG_SHA_256_VIA_LOWLEVEL_OR_PSA)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DIGEST_ALG_SHA256,
                       "id-sha256",
                       "SHA-256"),
        MBEDTLS_MD_SHA256,
    },
...
#if defined(MBEDTLS_HAS_ALG_SHA_384_VIA_LOWLEVEL_OR_PSA)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DIGEST_ALG_SHA384,
                       "id-sha384",
                       "SHA-384"),
        MBEDTLS_MD_SHA384,
    },
...
#if defined(MBEDTLS_HAS_ALG_SHA_512_VIA_LOWLEVEL_OR_PSA)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_DIGEST_ALG_SHA512,
                       "id-sha512",
                       "SHA-512"),
        MBEDTLS_MD_SHA512,
    },
...
#if defined(MBEDTLS_HAS_ALG_SHA_224_VIA_LOWLEVEL_OR_PSA)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_SHA224,
                       "hmacSHA224",
                       "HMAC-SHA-224"),
        MBEDTLS_MD_SHA224,
    },
...
#if defined(MBEDTLS_HAS_ALG_SHA_256_VIA_LOWLEVEL_OR_PSA)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_SHA256,
                       "hmacSHA256",
                       "HMAC-SHA-256"),
        MBEDTLS_MD_SHA256,
    },
...
#if defined(MBEDTLS_HAS_ALG_SHA_384_VIA_LOWLEVEL_OR_PSA)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_SHA384,
                       "hmacSHA384",
                       "HMAC-SHA-384"),
        MBEDTLS_MD_SHA384,
    },
...
#if defined(MBEDTLS_HAS_ALG_SHA_512_VIA_LOWLEVEL_OR_PSA)
    {
        OID_DESCRIPTOR(MBEDTLS_OID_HMAC_SHA512,
                       "hmacSHA512",
                       "HMAC-SHA-512"),
        MBEDTLS_MD_SHA512,
    },
