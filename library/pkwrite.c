                             ...
                             mbedtls_ecp_keypair *ec)
{
    ...
    if ((ret =
             mbedtls_oid_get_oid_by_ec_grp(ec->grp.id, &oid, &oid_len)) != 0) {
        return ret;
    }
                                ...
                                unsigned char *buf, size_t size)
{
    ...
    *--c = 0;
    ...
    MBEDTLS_ASN1_CHK_ADD(len,
                         mbedtls_asn1_write_algorithm_identifier(&c, buf, oid,
                                                                 oid_len,
                                                                 par_len));
                                ...
                                unsigned char *buf, size_t size)
{
    ...
    if ((ret =
             mbedtls_pem_write_buffer(PEM_BEGIN_PUBLIC_KEY, PEM_END_PUBLIC_KEY,
                             ...
                             size_t size)
{
    ...
    if ((ret =
             mbedtls_pk_write_key_der(key, output_buf,
                                      sizeof(output_buf))) < 0) {
        return ret;
    }
