...
#if (defined(MBEDTLS_PSA_BUILTIN_ALG_MD5) || (defined(PSA_CRYPTO_DRIVER_TEST) && defined(MBEDTLS_PSA_ACCEL_ALG_MD5)))
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_RSA_PKCS1V15_SIGN) || defined(MBEDTLS_PSA_BUILTIN_ALG_RSA_OAEP) || \
        defined(MBEDTLS_PSA_BUILTIN_ALG_RSA_PSS) || defined(MBEDTLS_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA)
...
static psa_status_t hash_setup(mbedtls_psa_hash_operation_t* operation, psa_algorithm_t alg)
{
...
static psa_status_t hash_clone(const mbedtls_psa_hash_operation_t* source_operation,
...
static psa_status_t hash_update(mbedtls_psa_hash_operation_t* operation, const uint8_t* input, size_t input_length)
{
        int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static psa_status_t hash_finish(mbedtls_psa_hash_operation_t* operation, uint8_t* hash, size_t hash_size,
                                size_t* hash_length)
{
        psa_status_t status;
        int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static psa_status_t hash_compute(psa_algorithm_t alg, const uint8_t* input, size_t input_length, uint8_t* hash,
...
psa_status_t mbedtls_psa_hash_compute(psa_algorithm_t alg, const uint8_t* input, size_t input_length, uint8_t* hash,
                                      size_t hash_size, size_t* hash_length)
{
        return (hash_compute(alg, input, input_length, hash, hash_size, hash_length));
}
...
psa_status_t mbedtls_psa_hash_finish(mbedtls_psa_hash_operation_t* operation, uint8_t* hash, size_t hash_size,
                                     size_t* hash_length)
{
...
psa_status_t mbedtls_transparent_test_driver_hash_compute(psa_algorithm_t alg, const uint8_t* input,
...
psa_status_t mbedtls_transparent_test_driver_hash_setup(mbedtls_transparent_test_driver_hash_operation_t* operation,
                                                        psa_algorithm_t alg)
{
        if (is_hash_accelerated(alg))
                return (hash_setup(operation, alg));
...
psa_status_t
mbedtls_transparent_test_driver_hash_clone(const mbedtls_transparent_test_driver_hash_operation_t* source_operation,
...
psa_status_t mbedtls_transparent_test_driver_hash_update(mbedtls_transparent_test_driver_hash_operation_t* operation,
...
psa_status_t mbedtls_transparent_test_driver_hash_finish(mbedtls_transparent_test_driver_hash_operation_t* operation,
...
psa_status_t mbedtls_transparent_test_driver_hash_abort(mbedtls_transparent_test_driver_hash_operation_t* operation)
{
        return (hash_abort(operation));
}
