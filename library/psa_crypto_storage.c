                                     ...
                                     uint8_t                         *storage_data)
{
    ...
    MBEDTLS_PUT_UINT32_LE(attr->policy.alg, storage_format->policy,
                          sizeof(uint32_t));
    MBEDTLS_PUT_UINT32_LE(attr->policy.alg2, storage_format->policy,
                          2 * sizeof(uint32_t));
...
psa_status_t psa_parse_key_data_from_storage(
    const uint8_t             *storage_data,
    ...
    psa_core_key_attributes_t *attr)
{
    ...
    *key_data_length = MBEDTLS_GET_UINT32_LE(storage_format->data_len, 0);
    ...
    attr->policy.alg   =
        MBEDTLS_GET_UINT32_LE(storage_format->policy, sizeof(uint32_t));
    attr->policy.alg2 = MBEDTLS_GET_UINT32_LE(storage_format->policy,
                                              2 * sizeof(uint32_t));
                                     ...
                                     const size_t                    data_length)
{
    ...
    storage_data_length = data_length +
