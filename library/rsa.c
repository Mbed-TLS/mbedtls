                             ...
                             mbedtls_md_type_t hash_id )
{
        ...
        ( hash_id != MBEDTLS_MD_NONE ) )
    {
        ...
        if( mbedtls_md_internal_get_size( hash_id ) == 0 )
            return( MBEDTLS_ERR_RSA_INVALID_PADDING );
    }
#endif /* MBEDTLS_PKCS1_V21 */
                            ...
                            unsigned char *output )
{
    ...
    hlen = mbedtls_md_internal_get_size( (mbedtls_md_type_t) ctx->hash_id );
    if( hlen == 0 )
        return( MBEDTLS_ERR_RSA_BAD_INPUT_DATA );
                         ...
                         unsigned char *sig )
{
    ...
    if( md_alg != MBEDTLS_MD_NONE )
    {
        ...
        size_t exp_hashlen = mbedtls_md_internal_get_size( md_alg );
        if( exp_hashlen == 0 )
            return( MBEDTLS_ERR_RSA_BAD_INPUT_DATA );
                               ...
                               const unsigned char *sig )
{
    ...
    hlen = mbedtls_md_internal_get_size( mgf1_hash_id );
    if( hlen == 0 )
        return( MBEDTLS_ERR_RSA_BAD_INPUT_DATA );
