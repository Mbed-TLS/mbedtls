                                 ...
                                 const unsigned char *sig )
{
    ...
    /* Set first two bytes of the buffer so that code checkers will not think we are accessing uninitialized data (normally mbedtls_rsa_public or mbedtls_rsa_private would fill the buffer). values chosen are intentionally invalid*/
    buf[0] = 1; 
    buf[1] = 0;
