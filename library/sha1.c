...
#define R(t)                                                                                                       \
        (local.temp =                                                                                              \
                 local.W[((t)-3) & 0x0F] ^ local.W[((t)-8) & 0x0F] ^ local.W[((t)-14) & 0x0F] ^ local.W[(t)&0x0F], \
...
static const unsigned char sha1_test_sum[3][20] = {{0xA9, 0x99, 0x3E, 0x36, 0x47, 0x06, 0x81, 0x6A, 0xBA, 0x3E,
