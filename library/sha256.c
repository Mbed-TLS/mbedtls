...
{
    MBEDTLS_TRACE_PRIM_OP_CTX( "sha256", "init", ctx );
...
{
    MBEDTLS_TRACE_PRIM_OP_CTX( "sha256", "free", ctx );
    if( ctx == NULL )
        return;
...
{
    MBEDTLS_TRACE_PRIM_OP_CTX_CTX( "sha256", "clone", src, dst );
                               ...
                               size_t ilen )
{
    ...
    MBEDTLS_TRACE_PRIM_OP_CTX_BYTES( "sha256", "update", ctx, ilen );
    SHA256_VALIDATE_RET( ctx != NULL );
