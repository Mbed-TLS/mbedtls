 ...
 *
 * \note            This same validation is used by ssl_write_client_hello while
 *                  selecting possible cipher suites and by
 *                  ssl_parse_server_hello when validating server's choice.
 *
