...
static inline size_t mbedtls_ssl_get_output_buflen(
...
static inline size_t mbedtls_ssl_get_input_buflen(
    const mbedtls_ssl_context *ctx)
{
#if defined(MBEDTLS_SSL_DTLS_CONNECTION_ID)
...
struct mbedtls_ssl_handshake_params {
    ...
    void (*update_checksum)(mbedtls_ssl_context *, const unsigned char *,
                            size_t);
...
static inline int mbedtls_ssl_conf_is_tls12_enabled(
    const mbedtls_ssl_config *conf)
{
#if defined(MBEDTLS_SSL_PROTO_TLS1_2)
    return conf->min_tls_version <= MBEDTLS_SSL_VERSION_TLS1_2 &&
 ...
 */
static inline unsigned mbedtls_ssl_conf_tls13_check_kex_modes(
    mbedtls_ssl_context *ssl,
    int kex_mode_mask)
{
...
static inline int mbedtls_ssl_conf_tls13_psk_ephemeral_enabled(
    mbedtls_ssl_context *ssl)
{
    return mbedtls_ssl_conf_tls13_check_kex_modes(ssl,
...
static inline int mbedtls_ssl_conf_tls13_some_ephemeral_enabled(
    mbedtls_ssl_context *ssl)
{
    return mbedtls_ssl_conf_tls13_check_kex_modes(ssl,
...
static inline int mbedtls_ssl_conf_tls13_some_psk_enabled(
    mbedtls_ssl_context *ssl)
{
    return mbedtls_ssl_conf_tls13_check_kex_modes(ssl,
 ...
 *         !=0 otherwise.
 */
static inline unsigned mbedtls_ssl_tls13_check_kex_modes(
    mbedtls_ssl_context *ssl,
    int kex_modes_mask)
{
...
static inline int mbedtls_ssl_tls13_some_ephemeral_enabled(
    mbedtls_ssl_context *ssl)
{
    return !mbedtls_ssl_tls13_check_kex_modes(ssl,
                                              MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ALL);
...
#if defined(MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ENABLED)
static inline int mbedtls_ssl_sig_alg_is_received(
    const mbedtls_ssl_context *ssl,
