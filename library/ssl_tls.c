...
static void ssl_calc_verify_tls_sha256(const mbedtls_ssl_context *,
                                       unsigned char *,
                                       size_t *);
static void ssl_calc_finished_tls_sha256(mbedtls_ssl_context *,
                                         unsigned char *,
                                         int);
...
static void ssl_calc_verify_tls_sha384(const mbedtls_ssl_context *,
                                       unsigned char *,
                                       size_t *);
static void ssl_calc_finished_tls_sha384(mbedtls_ssl_context *,
                                         unsigned char *,
                                         int);
...
#if defined(MBEDTLS_HAS_ALG_SHA_384_VIA_MD_OR_PSA_BASED_ON_USE_PSA)
        case MBEDTLS_MD_SHA384:
            return(ssl_get_handshake_transcript_sha384(ssl, dst, dst_len,
                                                       olen));
#endif /* MBEDTLS_HAS_ALG_SHA_384_VIA_MD_OR_PSA_BASED_ON_USE_PSA*/

#if defined(MBEDTLS_HAS_ALG_SHA_256_VIA_MD_OR_PSA_BASED_ON_USE_PSA)
        case MBEDTLS_MD_SHA256:
            return(ssl_get_handshake_transcript_sha256(ssl, dst, dst_len,
                                                       olen));
#endif /* MBEDTLS_HAS_ALG_SHA_256_VIA_MD_OR_PSA_BASED_ON_USE_PSA*/
