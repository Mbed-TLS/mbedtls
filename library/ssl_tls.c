...
int mbedtls_ssl_get_record_expansion( const mbedtls_ssl_context *ssl )
{
    ...
    size_t in_hdr_len, out_hdr_len, max_hdr_len;
    in_hdr_len = mbedtls_ssl_in_hdr_len( ssl );
    out_hdr_len = mbedtls_ssl_out_hdr_len( ssl );
    if( in_hdr_len < out_hdr_len )
        max_hdr_len = out_hdr_len;
    else
        max_hdr_len = in_hdr_len;

    if( transform == NULL )
        return( (int) max_hdr_len );
    ...
    return( (int)( max_hdr_len + transform_expansion ) );
}
