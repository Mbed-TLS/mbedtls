...
#if defined(MBEDTLS_ECDSA_C) && defined(MBEDTLS_MD_CAN_SHA512) && \
...
#endif /* MBEDTLS_X509_RSASSA_PSS_SUPPORT && MBEDTLS_MD_CAN_SHA512 */

#if defined(MBEDTLS_X509_RSASSA_PSS_SUPPORT) && defined(MBEDTLS_MD_CAN_SHA384)
    MBEDTLS_TLS1_3_SIG_RSA_PSS_RSAE_SHA384,
#endif /* MBEDTLS_X509_RSASSA_PSS_SUPPORT && MBEDTLS_MD_CAN_SHA384 */

#if defined(MBEDTLS_X509_RSASSA_PSS_SUPPORT) && defined(MBEDTLS_MD_CAN_SHA256)
    MBEDTLS_TLS1_3_SIG_RSA_PSS_RSAE_SHA256,
#endif /* MBEDTLS_X509_RSASSA_PSS_SUPPORT && MBEDTLS_MD_CAN_SHA256 */
...
#if defined(MBEDTLS_SSL_FIN_SHA256_PSA) || defined(MBEDTLS_SSL_FIN_SHA384_PSA)
...
#else /* hash transcript through PSA */
...
#endif /* MBEDTLS_SSL_FIN_SHA384_LEGACY */
...
#endif /* MBEDTLS_SSL_FIN_SHA256_LEGACY */
...
#endif /* hash transcript through legacy */
                                 ...
                                 size_t *hlen )
{
    ...
    *hlen = 32;
    ...
    mbedtls_sha256_free( &sha256 );
#endif /* !MBEDTLS_SSL_FIN_SHA256_PSA */
    return;
}
#endif /* MBEDTLS_SSL_FIN_SHA256_PSA || MBEDTLS_SSL_FIN_SHA256_LEGACY */
                                 ...
                                 size_t *hlen )
{
    ...
    *hlen = 48;
    ...
    mbedtls_sha512_free( &sha512 );
#endif /* !MBEDTLS_SSL_FIN_SHA384_PSA */
    return;
}
#endif /* MBEDTLS_SSL_FIN_SHA384_PSA || MBEDTLS_SSL_FIN_SHA384_LEGACY */
