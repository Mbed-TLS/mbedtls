                                  ...
                                  mbedtls_x509_sequence *ext_key_usage)
{
    ...
    if ((ret =
             mbedtls_asn1_get_sequence_of(p, end, ext_key_usage,
                                          MBEDTLS_ASN1_OID)) != 0) {
        return MBEDTLS_ERROR_ADD(MBEDTLS_ERR_X509_INVALID_EXTENSIONS, ret);
    }
...
int mbedtls_x509_crt_parse_der_with_ext_cb(mbedtls_x509_crt *chain,
                                           ...
                                           void *p_ctx)
{
    return mbedtls_x509_crt_parse_der_internal(chain,
                                               buf,
                                               buflen,
                                               make_copy,
                                               cb,
                               ...
                               unsigned char ns_cert_type)
{
    ...
    CERT_TYPE(MBEDTLS_X509_NS_CERT_TYPE_OBJECT_SIGNING_CA,
              "Object Signing CA");
...
static int x509_info_cert_policies(char **buf,
                                   size_t *size,
                                 ...
                                 int top)
{
    ...
    if (need_ca_bit &&
        mbedtls_x509_crt_check_key_usage(parent,
