...
* [`cipher/pbcrypt.c`](cipher/pbcrypt.c): file encryption and authentication with a key derived from a password, demonstrating the authenticated cipher interface and password-based key derivation.
