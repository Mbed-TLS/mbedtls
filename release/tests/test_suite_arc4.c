 ...
 *      Test suite file : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_arc4.function
 *      Test suite data : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_arc4.data
 *
 *
...
#line 11 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_arc4.function"
void test_suite_mbedtls_arc4_crypt( char *hex_src_string, char *hex_key_string,
                 char *hex_dst_string )
{
...
#line 42 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_arc4.function"
void test_suite_arc4_selftest()
{
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "mbedtls_arc4_crypt" ) == 0 )
    {
        ...
        test_suite_mbedtls_arc4_crypt( param1, param2, param3 );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "arc4_selftest" ) == 0 )
    {
    #ifdef MBEDTLS_SELF_TEST
...
#define USAGE \
    ...
    argv[0], \
    "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_arc4.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_arc4.data";
