 ...
 *      Test suite file : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.function
 *      Test suite data : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.data
 *
 *
...
#endif /* defined(MBEDTLS_BLOWFISH_C) */
...
int verify_int( char *str, int *value )
{
    ...
    {
        *value = ( MBEDTLS_ERR_BLOWFISH_INVALID_INPUT_LENGTH );
...
#line 11 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.function"
...
#line 45 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CBC
#line 79 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CBC
#line 118 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.function"
...
#line 156 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.function"
...
#ifdef MBEDTLS_CIPHER_MODE_CFB
#line 191 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.function"
...
#line 226 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.function"
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "blowfish_encrypt_ecb" ) == 0 )
    {
        ...
        test_suite_blowfish_encrypt_ecb( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "blowfish_decrypt_ecb" ) == 0 )
    {
        ...
        test_suite_blowfish_decrypt_ecb( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "blowfish_encrypt_cbc" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CBC
        ...
        test_suite_blowfish_encrypt_cbc( param1, param2, param3, param4, param5 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_CBC */
    ...
    if( strcmp( params[0], "blowfish_decrypt_cbc" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CBC
        ...
        test_suite_blowfish_decrypt_cbc( param1, param2, param3, param4, param5 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_CBC */
    ...
    if( strcmp( params[0], "blowfish_encrypt_cfb64" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CFB
        ...
        test_suite_blowfish_encrypt_cfb64( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_CFB */
    ...
    if( strcmp( params[0], "blowfish_decrypt_cfb64" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CFB
        ...
        test_suite_blowfish_decrypt_cfb64( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_CFB */
    ...
    if( strcmp( params[0], "blowfish_encrypt_ctr" ) == 0 )
    {
    #ifdef MBEDTLS_CIPHER_MODE_CTR
        ...
        test_suite_blowfish_encrypt_ctr( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_CIPHER_MODE_CTR */
...
#define USAGE \
    ...
    argv[0], \
    "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_blowfish.data";
