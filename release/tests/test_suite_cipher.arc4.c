 ...
 *      Test suite data : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_cipher.arc4.data
 *
 *
...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "MBEDTLS_CIPHER_ARC4_128" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_ARC4_128 );
...
int dep_check( char *str )
{
    ...
    if( strcmp( str, "MBEDTLS_ARC4_C" ) == 0 )
    {
...
#define USAGE \
    ...
    argv[0], \
    "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_cipher.arc4.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_cipher.arc4.data";
