 ...
 *      Test suite data : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_cipher.ccm.data
 *
 *
...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "MBEDTLS_CIPHER_CAMELLIA_128_CCM" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_CAMELLIA_128_CCM );
        return( KEY_VALUE_MAPPING_FOUND );
    }
#endif // MBEDTLS_CIPHER_MODE_AEAD
#ifdef MBEDTLS_CIPHER_MODE_AEAD
    if( strcmp( str, "MBEDTLS_CIPHER_AES_192_CCM" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_AES_192_CCM );
        return( KEY_VALUE_MAPPING_FOUND );
    }
#endif // MBEDTLS_CIPHER_MODE_AEAD
#ifdef MBEDTLS_CIPHER_MODE_AEAD
    if( strcmp( str, "MBEDTLS_CIPHER_AES_256_CCM" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_AES_256_CCM );
        return( KEY_VALUE_MAPPING_FOUND );
    }
#endif // MBEDTLS_CIPHER_MODE_AEAD
#ifdef MBEDTLS_CIPHER_MODE_AEAD
    if( strcmp( str, "MBEDTLS_CIPHER_AES_128_CCM" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_AES_128_CCM );
        return( KEY_VALUE_MAPPING_FOUND );
    }
#endif // MBEDTLS_CIPHER_MODE_AEAD
...
#define USAGE \
    ...
    argv[0], \
    "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_cipher.ccm.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_cipher.ccm.data";
