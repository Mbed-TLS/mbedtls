 ...
 *      Test suite data : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_cipher.des.data
 *
 *
...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "MBEDTLS_CIPHER_DES_ECB" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_DES_ECB );
        return( KEY_VALUE_MAPPING_FOUND );
    }
    ...
    if( strcmp( str, "MBEDTLS_CIPHER_DES_EDE_ECB" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_DES_EDE_ECB );
        return( KEY_VALUE_MAPPING_FOUND );
    }
    ...
    if( strcmp( str, "MBEDTLS_CIPHER_DES_EDE3_CBC" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_DES_EDE3_CBC );
        return( KEY_VALUE_MAPPING_FOUND );
    }
    ...
    if( strcmp( str, "MBEDTLS_CIPHER_DES_EDE_CBC" ) == 0 )
    {
        *value = ( MBEDTLS_CIPHER_DES_EDE_CBC );
        return( KEY_VALUE_MAPPING_FOUND );
    }
...
#define USAGE \
    ...
    argv[0], \
    "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_cipher.des.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_cipher.des.data";
