 ...
 *      Test suite file : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.function
 *      Test suite data : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.data
 *
 *
...
#ifdef MBEDTLS_MD2_C
#line 9 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.function"
...
#ifdef MBEDTLS_MD4_C
#line 29 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.function"
...
#ifdef MBEDTLS_MD5_C
#line 49 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.function"
...
#line 69 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.function"
...
#line 89 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.function"
...
#ifdef MBEDTLS_MD4_C
#ifdef MBEDTLS_SELF_TEST
#line 96 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.function"
...
#ifdef MBEDTLS_MD5_C
#ifdef MBEDTLS_SELF_TEST
#line 103 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.function"
...
#ifdef MBEDTLS_RIPEMD160_C
#ifdef MBEDTLS_SELF_TEST
#line 110 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.function"
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "md2_text" ) == 0 )
    {
        ...
        test_suite_md2_text( param1, param2 );
    ...
    if( strcmp( params[0], "md4_text" ) == 0 )
    {
        ...
        test_suite_md4_text( param1, param2 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_MD4_C */
    ...
    if( strcmp( params[0], "md5_text" ) == 0 )
    {
        ...
        test_suite_md5_text( param1, param2 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_MD5_C */
    ...
    if( strcmp( params[0], "ripemd160_text" ) == 0 )
    {
    #ifdef MBEDTLS_RIPEMD160_C
        ...
        test_suite_ripemd160_text( param1, param2 );
        return ( DISPATCH_TEST_SUCCESS );
    #endif /* MBEDTLS_RIPEMD160_C */
    ...
    if( strcmp( params[0], "md2_selftest" ) == 0 )
    {
    #ifdef MBEDTLS_MD2_C
    #ifdef MBEDTLS_SELF_TEST
    ...
    if( strcmp( params[0], "md4_selftest" ) == 0 )
    {
    #ifdef MBEDTLS_MD4_C
    #ifdef MBEDTLS_SELF_TEST
    ...
    if( strcmp( params[0], "md5_selftest" ) == 0 )
    {
    #ifdef MBEDTLS_MD5_C
    #ifdef MBEDTLS_SELF_TEST
    ...
    if( strcmp( params[0], "ripemd160_selftest" ) == 0 )
    {
    #ifdef MBEDTLS_RIPEMD160_C
    #ifdef MBEDTLS_SELF_TEST
...
#define USAGE \
    ...
    argv[0], \
    "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_mdx.data";
