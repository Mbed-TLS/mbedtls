 ...
 *
 * Test file      : test_suite_milagro_p2p.c
 *
 ...
 *      Test suite file : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_milagro_p2p.function
 *      Test suite data : /Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_milagro_p2p.data
 *
 *
...
#endif /* defined(MBEDTLS_MILAGRO_P2P_C) */
...
#line 11 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_milagro_p2p.function"
void test_suite_milagro_p2p_do(char *client_identity, char *server_identity, 
                                char *client_secret, char *server_secret )
{
     ...
     */
    size_t len1, len2;
    unsigned char *p2p_client_key = unhexify_alloc(client_secret,&len1);
    unsigned char *p2p_server_key = unhexify_alloc(server_secret,&len2);    
     ...
     */
    int value_eq_key = 0;
    for (int i = 0; i<milagro_p2p_client.shared_secret.len; i++)
    {
...
#line 97 "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_milagro_p2p.function"
void test_suite_milagro_p2p_fail(char *client_identity, char *server_identity, 
                                char *client_secret, char *server_secret )
{
    /*
     * Initializate parameters
     ...
     * Allocate memory 
     */
    TEST_ASSERT( mbedtls_milagro_p2p_alloc_memory(MBEDTLS_MILAGRO_IS_CLIENT, &milagro_p2p_client) == 0 );
    TEST_ASSERT( mbedtls_milagro_p2p_alloc_memory(MBEDTLS_MILAGRO_IS_SERVER, &milagro_p2p_server) == 0 );
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "milagro_p2p_do" ) == 0 )
    {
        ...
        test_suite_milagro_p2p_do( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "milagro_p2p_fail" ) == 0 )
    {
        ...
        test_suite_milagro_p2p_fail( param1, param2, param3, param4 );
        return ( DISPATCH_TEST_SUCCESS );
...
#define USAGE \
    ...
    argv[0], \
    "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_milagro_p2p.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "/Users/alessandrobudroni/Dev/milagro-mbedtls/tests/suites/test_suite_milagro_p2p.data";
