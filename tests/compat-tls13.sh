...
# Purpose
#
# Executes tls13 compat tests to prove various TLS/SSL options and extensions.
#
#
# The tests are in `compat-tls13-testcases.sh`, other parts are directly copied
# from `ssl-opt.sh`
#
