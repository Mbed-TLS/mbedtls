...
component_test_psa_crypto_config_basic() {
    ...
    loc_cflags="${loc_cflags} -DMBEDTLS_PSA_ACCEL_ALG_CCM"
    loc_cflags="${loc_cflags} -DMBEDTLS_PSA_ACCEL_ALG_GCM"
    loc_cflags="${loc_cflags} -DMBEDTLS_PSA_ACCEL_ALG_CHACHA20_POLY1305"
