...
pre_define_component_groups () {
    ...
    group10=(build_tfm_armcc test_block_cipher_no_decrypt_aesce_armcc test_psa_compliance)
    group10+=(build_aes_armce test_tfm_config test_tls1_2_ecjpake_compatibility test_tls13_only_psk)
    group10+=(test_tls13_only_psk_ephemeral build_aes_aesce_armcc test_tfm_config_p256m_driver_accel_ec)
    ...
    group11=(test_no_date_time test_when_no_ciphersuites_have_mac test_psa_crypto_rsa_no_genprime)
    group11+=(test_psa_crypto_client test_tls13_only_ephemeral_ffdh)

    group12=(test_small_ssl_dtls_max_buffering test_se_default build_armcc test_new_psa_want_key_pair_symbol)
    ...
    group14=(test_tls1_2_default_stream_cipher_only test_small_ssl_in_content_len test_small_ssl_out_content_len)
    group14+=(test_tls1_2_default_cbc_legacy_cipher_only)
    ...
    group16=(test_tls1_2_default_cbc_legacy_cbc_etm_cipher_only_use_psa)
    group16+=(test_no_max_fragment_length_small_ssl_out_content_len)

    group17=(test_everest test_everest_curve25519_only test_m32_everest)

    group18=(test_no_64bit_multiplication test_no_platform test_no_strings)

    group19=(test_psa_collect_statuses test_platform_calloc_macro test_gcc_earliest_opt)

    group20=(test_no_udbl_division test_mx32 test_min_mpi_window_size)

    group21=(test_clang_earliest_opt test_full_block_cipher_psa_dispatch test_psa_crypto_config_reference_ffdh)
    ...
    groups+=(group15 group16 group17 group18 group19)
