...
component_build_deprecated () {
    ...
    make CC=gcc PTHREAD=1 CFLAGS='-O -Werror -Wall -Wextra -Wno-unused-function' tests
    ...
    make CC=clang PTHREAD=1 CFLAGS='-O -Werror -Wall -Wextra -Wno-unused-function' tests
}
...
component_test_check_params_functionality () {
    ...
    make CC=gcc PTHREAD=1 CFLAGS='-Werror -O1' lib test
}
