...
# generate_visualc_files enumerates source files (library/*.c, tests/src/*.c).
# It doesn't care about their content, but the files must exist. So it must
# run after the steps that creates or updates these files.
