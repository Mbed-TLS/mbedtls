...
echo 'Running pylint ...'
$PYTHON -m pylint scripts/mbedtls_dev/*.py scripts/*.py tests/scripts/*.py tests/scripts/tls13_compat/*.py || {
...
echo
echo 'Running mypy ...'
$PYTHON -m mypy scripts/*.py tests/scripts/*.py tests/scripts/tls13_compat/*.py ||
  ret=1
