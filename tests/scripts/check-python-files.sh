...
can_pylint () {
    ...
    #     E: 34, 0: Unable to import 'framework_dev' (import-error)
...
can_mypy () {
    ...
    #     tests/scripts/test_psa_constant_names.py:34: error: Cannot find implementation or library stub for module named 'framework_dev'
