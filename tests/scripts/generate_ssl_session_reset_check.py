...
RULES = {
    ...
    'in_content_len': ssl_session_reset_check.ResetBehavior.KEEP,
    ...
    'out_content_len': ssl_session_reset_check.ResetBehavior.KEEP,
...
SPECIAL_BEHAVIORS = {
    ...
    'in_buf_len': ['#if defined(MBEDTLS_SSL_RUNTIME_CONTENT_LEN)',
                   'TEST_ASSERT(after->in_buf_len == MBEDTLS_SSL_IN_BUFFER_LEN -',
                   '            (MBEDTLS_SSL_IN_CONTENT_LEN - after->in_content_len));',
                   '#else',
                   'TEST_ASSERT(after->in_buf_len == MBEDTLS_SSL_IN_BUFFER_LEN);',
                   '#endif'],
    'out_buf_len': ['#if defined(MBEDTLS_SSL_RUNTIME_CONTENT_LEN)',
